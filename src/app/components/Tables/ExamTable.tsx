            ...
            <table className="w-full border-collapse bg-white rounded-lg">
                <thead className="bg-[#f8f8f8]">
                    <tr>
                        ...
                        <th className="p-3 text-center text-base font-[100] text-[#B0B0B0]">S.No.</th>
                        ...
                        <th className="p-3 text-center text-base font-[100] text-[#B0B0B0]">Subject</th>
                        <th className="p-3 text-center text-base font-[100] text-[#B0B0B0]">Date</th>
                ...
                <tbody className="rounded-xl">
                    <tr className="border-t">
                        ...
                        <td className="p-3 text-center text-[13px] font-[300] text-[#333D61]">1</td>
                        <td className="p-3 text-center text-[13px] font-[300] text-[#333D61]">Class Test</td>
                        ...
                        <td className="p-3 text-center text-[13px] font-[300] text-[#333D61]">Mathematics</td>
                        <td className="p-3 text-center text-[13px] font-[300] text-[#333D61]">10-Nov-2023</td>
