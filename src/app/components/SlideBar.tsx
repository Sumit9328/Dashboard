      ...
      <div className="bg-[#fafaf8] w-[311px]">
        <>
          ...
          <div className="d-flex ps-5 pt-3 pb-3 justify-content-center align-items-center mb-4">
            ...
            <div className="mb-0 p-0 m-0 ff-aTypeDisplay col-md-10 flex items-center justify-between">
              <Link className="no-underline" href='/teacher'>
                <span className="text-[15px] font-[100] font-[100] text-[#B6B6B5] no-underline ml-1">Teacher</span>
              </Link>
            </div>
          </div>
          <div className="d-flex ps-5 pt-3 pb-3 justify-content-center align-items-center mb-4">
            ...
            <div className="mb-0 p-0 m-0 ff-aTypeDisplay col-md-10 flex items-center justify-between">
              <Link className="no-underline" href='/admission'>
                ...
                <span className="text-[15px] font-[100] font-[100] text-[#B6B6B5] no-underline ml-1">Admission</span>
              </Link>
            </div>
          </div>
          <div className="d-flex ps-5 pt-3 pb-3 justify-content-center align-items-center mb-4">
            ...
            <div className="mb-0 p-0 m-0 ff-aTypeDisplay col-md-10 flex items-center justify-between">
              <Link className="no-underline" href='/account'>
                ...
                <span className="text-[15px] font-[100] font-[100] text-[#B6B6B5] no-underline ml-1">Account</span>
              </Link>
            </div>
          </div>
          ...
          <div className="d-flex ps-5 pt-3 pb-3 justify-content-center align-items-center mb-4">
            ...
            <div className="mb-0 p-0 m-0 ff-aTypeDisplay col-md-10 flex items-center justify-between">
              <Link className="no-underline" href='/transport'>

                <span className="text-[15px] font-[100] font-[100] text-[#B6B6B5] no-underline ml-1">Transport</span>
              </Link>
            </div>
          </div>
