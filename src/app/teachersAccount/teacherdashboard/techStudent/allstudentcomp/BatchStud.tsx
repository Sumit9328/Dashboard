...
export default function BatchStud() {
  const [selectedCountry, setSelectedCountry] = useState("Select Batch");
  ...
  const handleSelect = (country: string) => { // Explicit type for 'country'
    setSelectedCountry(country);
    setIsOpen(false);
  };

  return (
    <div className="w-[100px] mx-auto mt-2">
